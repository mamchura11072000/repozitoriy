...
class Users {
    ...
    public function addCardsUser(){
   		$id = _MainModel::table("dd_user_cards")->add(array( "id", "level" => "3", "user_type" => "volunter", "image" => "null", "nickname" => "dmitriev", "rating" => "5", "description" => "dfghj", "role" => "user", "status" => "active"))->send();
