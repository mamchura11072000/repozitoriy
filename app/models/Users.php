...
//---------------------------------------------------------------------------------------------------------------------
    ...
    public function editCardsUser(){
    	...
    	$j = $_GET ['status'];
            ...
            $result1=_MainModel::table("dd_user_cards")->edit(array(array('level' => $b))||(array('user_type' => $c))||(array('image' => $d))|| (array('nickname' => $e))||(array('rating' => $f))||(array('description' => $g))|| (array('role' => $h))|| (array('status' => $j))), array('id'=>$a))->send();
    	}
